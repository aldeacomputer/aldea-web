...
//  ogType: 'website',
//  ogUrl: 'https://aldeacomputer.com',
//  ogImage: 'https://aldeacomputer.com/images/meta-image.png',
//
...
//  twitterImage: 'https://aldeacomputer.com/images/meta-image.png',
//})
...
const timelineYears: TimelineItem[] = [
  {
    icon: CaCheckmarkOutline,
    year: 2022,
    ...
    icon: CaTask,
    year: 2023,
    description: 'Q4 Devnet launches. Early access developer program.',
  }, {
    icon: CaRocket,
    year: 2024,
